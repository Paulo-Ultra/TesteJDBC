...
import io.github.dbcar.repositories.ClientsRepository;
...
public class ClientsService {
    ...
    public Client create(Client client) {
        Client createdClient = this.clientsRepository.create(client);
    ...
    public Client findById(Integer id) {
        Optional<Client> optionalClient = this.clientsRepository.findOne(id);
