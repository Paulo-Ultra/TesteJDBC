...
--------------------------------------------------------------------------------------------------
INSERT INTO CLIENTE (ID_CLIENTE, ID_USUARIO, CPF, TELEFONE, ENDERECO) VALUES (SEQ_CLIENTE.nextval, 5, '000.111.000-10', '(61)99999-9999', 'Rua Presidente Dutra, 09, Centro');

INSERT INTO CLIENTE (ID_CLIENTE, ID_USUARIO, CPF, TELEFONE, ENDERECO) VALUES (SEQ_CLIENTE.nextval, 5, '000.222.000-12', '(61)99999-9998', 'Rua Presidente Dutra, 154, Bairro Maria Cândida');

INSERT INTO CLIENTE (ID_CLIENTE, ID_USUARIO, CPF, TELEFONE, ENDERECO) VALUES (SEQ_CLIENTE.nextval, 6, '000.333.000-23', '(61)99999-9997', 'Avenida Antônio Carlos Guimar�es, 154A, Centro');

INSERT INTO CLIENTE (ID_CLIENTE, ID_USUARIO, CPF, TELEFONE, ENDERECO) VALUES (SEQ_CLIENTE.nextval, 7, '000.444.000-34', '(61)99999-9996', 'Avenida Boolevard, apartamento 1001, Parque dos Viajantes');

INSERT INTO CLIENTE (ID_CLIENTE, ID_USUARIO, CPF, TELEFONE, ENDERECO, SALDO) VALUES (SEQ_CLIENTE.nextval, 7, '000.555.000-45', '(61)99999-9995', 'Avenida das Flores, apartamento 505, Praça das Flores');
---------------------------------------------------------------------------------------------------
